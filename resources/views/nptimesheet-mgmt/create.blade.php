        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('nptimesheet-management.store') }}">
                        {{ csrf_field() }}
                         ...
                         <div class="form-group{{ $errors->has('week') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="week" value="{{ old('week') }}" required autofocus>
                        ...
                        <label for="department" class="col-md-4 control-label">Department Name</label>
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="task_id">
                                    @foreach ($nptasks as $nptask)
                                        <option value="{{$nptask->id}}">{{$nptask->nptask_name}}</option>
                                    @endforeach
                                </select><br>
                            </div>
                            ...
                            <div class="col-md-6">
                                <input id="remarks" type="text" class="form-control" name="remarks" placeholder="comment" value="{{ old('remarks') }}" required>
